...
def matrix_transpose(matrix):
    """ This modules transverse a 2D matrix
        ...
        Nested List comprehenssion explanation:
        nested list comprehension
        declares 0 as is the value will initialize each space
        in this new matrix, for _ as i dont want to run inside the array
        in range of rows
